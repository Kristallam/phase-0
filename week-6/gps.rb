...
What did you learn about making code readable by working on this challenge?
 I learned that by using different ruby methods it can make the code a lot more readable.

Did you learn any new methods? What did you learn about them?
  Yeah we learned to use has_key? so that got rid of the whole error = 3

What did you learn about accessing data in hashes?
  We can just access the data in the hash by setting the [key] so when we did that we didn't have to make an array

What concepts were solidified when working through this challenge?
  I think this challenged really helped me break down the code and comment out things to help me refactor. I think also my refactoring skills got a little bit better.
=end